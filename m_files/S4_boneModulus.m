...
% Clean memory
  clearvars -except nBones nMarrows nMediums nElements    ...
                    Marrow_Mask Medium_Mask a b m n       ...
                    Bone_Modulus_Map Grey_marrowThreshold;
%% 
...
% Clean memory
  clearvars -except nBones nMarrows nMediums nElements...
                    Marrow_Mask Medium_Mask           ...
                    Bone_Modulus_Map E_delta E_Min    ...
                    Modulus_Vector Pre_nMatcards      ...
                    E_Min_Bone GV_Min_Bone            ...
...
% Clean memory
  clearvars -except nBones nMarrows nMediums nElements...
                    nMatcards_Bone Marrow_Mask        ...
                    Medium_Mask Matcards_boneElement  ...
                    Matcards_boneInfo                 ...
                    E_Min_Bone GV_Min_Bone            ...
                    Grey_marrowThreshold;
%%
...
% Clean memory
  clearvars -except nBones nMarrows nMediums nElements...
                    nMatcards_Bone Marrow_Mask        ...
                    Medium_Mask  E_Min_Bone           ...
                    GV_Min_Bone Grey_marrowThreshold;
