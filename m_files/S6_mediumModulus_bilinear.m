...
% Calculate the second point
  GV_Midpoint = (GV_Min_Bone-Grey_marrowThreshold)*0.9 ...
              +  Grey_marrowThreshold;
...
% E=GV*a+b
  ...
  %%
% Clean memory
  clearvars -except nMatcards_Bone      ...
                    nMatcards_Marrow    ...
                    nMediums            ...
                    nElements           ...
                    Medium_Modulus_Map_1...
                    Medium_Modulus_Map_2
%% 
...
% preallocate the memory to Matcards_Element and Matcards_Info
 ...
 for p = 1:Pre_nMatcards;
    ...
    if  E_sel >= E_Min_Medium_1;
        ...
        Matcards_mediumElement_1(pointer) = nMatcards_Bone   ...
                                          + nMatcards_Marrow ...
                                          + p;
...
% Clean memory
  clearvars -except nMatcards_Bone       ...
                    ...
                    Medium_Modulus_Map_2 ...
                    nMatcards_Medium_1   ...
                    Matcards_mediumInfo_1 ...
                    Matcards_mediumElement_1 ...
                    nMediums_1
...
% preallocate the memory to Matcards_Element and Matcards_Info
 ...
 for p = 1:Pre_nMatcards;
    ...
    Matcards_mediumInfo_2(p,1) =  nMatcards_Bone   ...
                                + nMatcards_Marrow ...
                                + nMatcards_Medium_1 ...
                                + p;
    ...
    if  E_sel >= E_Min_Medium_2;
        ...
        Matcards_mediumElement_2(pointer) = nMatcards_Bone   ...
                                          + nMatcards_Marrow ...
                                          + nMatcards_Medium_1 ...
                                          + p;
...
% Clean memory
  clearvars -except nMatcards_Bone       ...
                    ...
                    nMatcards_Medium_1   ...
                    nMatcards_Medium_2   ...
                    Matcards_mediumInfo_2 ...
                    Matcards_mediumElement_2 ...
                    nMediums_1 ...
                    nMediums_2 ...
                    matCell_1 ...
                    changeCell_1
